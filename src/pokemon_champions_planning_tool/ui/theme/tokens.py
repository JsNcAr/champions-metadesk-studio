...
# ---------------------------------------------------------------------------
# Legacy compatibility — consumed only by ui/legacy.py during the migration.
# Deleted together with that file.
# ---------------------------------------------------------------------------
class Colors:
    """Pre-overhaul colour tokens. Do not use in new code."""

    WHITE = "white"
    BLACK = "black"
    BG_BASE = Palette.BG
    CARD_BG = Palette.SURFACE_2
    CARD_SELECTED = "#1E3A5F"
    PANEL_BG = "#111827"
    TOOLBAR_BG = Palette.SURFACE_2
    HEADER_BG = Palette.BG
    SURFACE_VARIANT = Palette.SURFACE_2
    DIVIDER = "#334155"
    GREY_300 = "#D1D5DB"
    GREY_400 = "#9CA3AF"
    GREY_500 = "#6B7280"
    ...
    BLUE_GREY_900 = Palette.SURFACE_2
