...
- Teams to plan against in the calculator, and the temporary team of the battle being played: `rival_team_id: UUID` (Primary Key), `name: str` (indexed), `kind: str` (`"saved"` or `"battle"`, indexed; at most one `battle` row exists), `source: str` (e.g. "Meta · Wolfe · Worlds", "Team preview", "Poképaste"), `notes: str`
