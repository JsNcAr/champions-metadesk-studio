...
- **613 automated tests** cover the domain rules, repositories, services and the UI. UI tests
...
- **Box.** Add Pokémon by name (forms and Megas normalised), filter by type, stats, tags,
  ...
  CSV.
- **Teams.** Six slot cards with forms, abilities, items with Champions legality
  ...
  export, team health checks, and offensive and defensive coverage grids. Each team is built
