...
- **551 automated tests** cover the domain rules, repositories, services and the UI. UI tests
...
- **Calc.** Both directions at once, with each side's best hit and who moves first always in
  ...
  (Crushed, Threat, Wall, Mitigated, Neutral) using their most-used tournament sets.
